...
public class FlowLayout extends ViewGroup {
    ...
    public void notifyData() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            params.height = mContext.getResources().getDimensionPixelOffset(R.dimen.main_series_item_text_height);
            int margin = mContext.getResources().getDimensionPixelOffset(R.dimen.main_series_item_text_margin);
